...
namespace Menu
{
	...
	void drawMenu()
	{
		...
		DrawText(TextFormat("PLAY"), static_cast<int>(Globals::Screen.size.x / 2  + 130 - (playBttn.buttonText[0].width / 2)), 210, 30, WHITE);
		...
		DrawText(TextFormat("CREDITS"), static_cast<int>(Globals::Screen.size.x / 2 + 100 - (creditsBttn.buttonText[0].width / 2)), 310, 30, WHITE);
		...
		DrawText(TextFormat("EXIT"), static_cast<int>(Globals::Screen.size.x / 2 + 130 - (exitBttn.buttonText[0].width / 2)), 410, 30, WHITE);
	...
	void initButtons()
	{
		...
		creditsBttn.position = { (Globals::Screen.size.x / 2 - (creditsBttn.buttonText[0].width / 2)), 300 };
		...
		exitBttn.position = { (Globals::Screen.size.x / 2 - (creditsBttn.buttonText[0].width / 2)), 400 };
	}
}